    ...
    <div>
      <div className={`container`}>
        <div
          className="email"
          onClick={event => {
            document.querySelector('.email').classList.add('expand');
        ...
        >
          <div className="from">
            <div className="from-contents">
              ...
              <div className="name">Randolph Gordon</div>
            </div>
          </div>
          <div className="to">
            <div className="to-contents">
              <div className="top">
                ...
                <div className="name-large">Randolph Gordon</div>
                <div
                  className="x-touch"
                  onClick={event => {
              ...
              <div className="bottom">
                <div className="row">
                  ...
                  <div className="link">
                    <a href="https://twitter.com/mikaelainalem">@poplogics</a>
                  </div>
                </div>
                <div className="row">
