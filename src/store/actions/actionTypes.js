...
export const INIT_CURRENT_MONTH_LAUNCHES = 'INIT_CURRENT_MONTH_LAUNCHES';

export const INIT_THIS_MONTH_LAUNCHES = 'INIT_THIS_MONTH_LAUNCHES';
...
export const SET_CURRENT_DAY_LAUNCHES = 'GET_CURRENT_DAY_LAUNCHES';
